...
public class VoIP {
    private static final int VOIP_CONNECTION_MIN_LAYER = 65;
    ...
    public static boolean isDebugOptionEnabled(@DebugOption int options) {
        return (debugOptions & options) == options;
    }

    public static void setDebugOptionEnabled(@DebugOption int option, boolean isEnabled) {
        debugOptions = isEnabled ? debugOptions | option : debugOptions & ~option;
    }
